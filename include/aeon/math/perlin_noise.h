...
public:
    ...
    double get_persistance() const { return persistence_; }
    ...
    void set_persistance(double persistence) { persistence_ = persistence; }
    ...
    void set_random_seed(int randomseed) { randomseed_ = randomseed; }
